    ...
    <!-- Links -->
       ...
       <div class="input-group md-form form-sm form-2 pl-0 "  >
          ...
          <div class="input-group-append ">
            ...
            @else
                <a style="min-width: 250px;" class="d-md-block d-sm-none text-right"><i class="fa fa-user-o" aria-hidden="true"> </i>&nbsp;Hola,    &nbsp;{{ Auth::user()->with('estudiante')->first()->estudiante()->first()->Nombres }} &nbsp;</a> 
