 ...
 $( "#sorden" ).change(function() {
    ...
    function orden(page)
    {
        ...
        switch(id) {
            ...
            break;
            case 2:
                window.location.href ="/oferta/categorias/{{$categoria->Categoria}}/precio_desc?page="+page;
            break;
            case 3:
                window.location.href ="/oferta/categorias/{{$categoria->Categoria}}/precio_asc?page="+page;
            break;
