                            ...
                            <div class="card-body row"  >
                                ...
                                <div class="col-md-8 col-sm-6 ">
                                        ...
                                        <p class="float-right " onclick='addcart({{$curso->curso->id}})' style="cursor: pointer;" ><i class="fa  fa-cart-plus  fa-2x" aria-hidden="true"></i></p> 
                                            ...
                                            <p class="h6-responsive " style="color:#616161; margin-bottom:0"><i class="fas fa-clock" aria-hidden="true"></i> {{$curso->curso->HorasClase}} Horas Clase &nbsp<i class="fa fa-certificate grey-text" aria-hidden="true">  </i>
