    ...
    {{csrf_field()}}
        ...
        <div class="row ">
            <div class="col-md-8 col-sm-12 ">
                ...
                <input type="tel" id="telefono" autocomplete="tel" class="form-control" placeholder="Número Telefónico*" aria-describedby="defaultRegisterFormPhoneHelpBlock" required
                
                
                
                
                 value="{{$estudiante[0]->Telefono}}" />
