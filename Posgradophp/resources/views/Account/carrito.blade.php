...
<h3 class="h3-responsive mt-4 font-weight-bold">Estudios agregados al carrito</h3>
    <div class="container ">
        <div class="row">
            ...
            <div class="card grey lighten-4 mb-4 mt-2">
                     <div class="card-body row">
                                <div class="col-4 " >
                                    <img src={{Session::get('cartItems')[$i]['Image_URL']}} class="w-100"/>
                                </div>
                                <div class="col-8">
                                    <p style="margin-bottom:0"> <p class="h4-responsive font-weight-bold" style="margin-bottom:0"> {{Session::get('cartItems')[$i]['curso'] }}</p>
                                    <p class="h6-responsive" style="color:#616161; margin-bottom:0">Horas Clase - 48 Horas</p>
                                    </p>
         ...
         @endfor
            ...
            <div class="card col-md-4 col-sm-12 grey lighten-4 mb-4 mt-2 " style="height:200px">
                ...
                <a class="btn btn-primary mt-4 w-95 mb-2"  onclick="proceder()" >Proceder al Pago</a>
    ...
    <div class="container" >
    <h3 class="h3-responsive mt-4 mb-4">Estudios agregados al carrito</h3>
